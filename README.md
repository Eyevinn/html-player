...
```
<link rel="stylesheet" href="https://player.eyevinn.technology/v0.2.3/build/eyevinn-html-player.css">
```
...
```
<script src="https://player.eyevinn.technology/v0.2.3/build/eyevinn-html-player.js" type="text/javascript"></script>
```
...
```
  <head>
    ...
    <link rel="stylesheet" href="https://player.eyevinn.technology/v0.2.3/build/eyevinn-html-player.css"></link>
  </head>
  <body>
